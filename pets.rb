...
require 'pry'
 ...
 def random_animal
   random_animal = HTTParty.get("http://api.petfinder.com/pet.getRandom?format=json&key=2fb23a71a91f020950eb1c8c33d73982&location=#{@animal_location}&distance=100&animal=#{@animal_type}&size=#{@animal_size}&age=#{@animal_age}&sex=#{@animal_sex}")
